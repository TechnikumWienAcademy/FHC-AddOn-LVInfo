...
if(version_compare($v['server'], '9.4', '<'))
{
	echo '<font style="color:red">Dieses Addon verwendet JSON-Datentypen in den Datenbank-Tabellen.<br/>Diese werden erst ab der Postgresql-Version 9.4 unterstützt.</font><br/>Ihre Postgresql-Version ist: '.$v['server'].'<br/><br/>';
	exit;
}
